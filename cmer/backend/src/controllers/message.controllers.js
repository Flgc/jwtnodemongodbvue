 ...
 *
 * file: src/controllers/message.controllers.js
 * Description: Responsável pelo CRUD da classe: 'Messages'
 * Data: 01/06/2021
 */
...
exports.index = async (req, res) => {
  res.status(200).json({ message: 'Hello World from Message Controllers' });
};
