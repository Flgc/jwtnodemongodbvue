 ...
 * mecanicaBot
 *
 * file: funcionarios.js
 * Description: Responsável pelos funcionarios no frontend
                          ...
                          <>
                            ...
                            <TableRow key={row.nome_usuario}>
                              <TableCell component="th" scope="row">
                                <Chip
                                  color="primary"
                                  avatar={<Avatar src={row.foto_perfil} />}
                              ...
                              <TableCell align="center">
                                <Chip
                                  color={getColor(row.tipo_usuario)}
                                  label={getTipo(row.tipo_usuario)}
                                ></Chip>
                              </TableCell>
                              ...
                              <TableCell align="center">{`${new Date(
                                ...
                                row.createdAt
                              ).toLocaleTimeString('pt-BR')}`}</TableCell>
                              ...
                              <TableCell align="right">
                                ...
                                >
                                  <Button
                                    ...
                                    color="primary"
                                    href={
                                      '/admin/funcionarios/editar/' + row._id
                                    }
                                  >
                                    Atualizar
                                  </Button>
